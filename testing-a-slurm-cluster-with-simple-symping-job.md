...
# Symping: the Slurm testing tool
{: #symping-tool}
...
For settings, authorization, and configuration information, see [Symping: the Slurm testing tool](/docs/en/SSZUMP_7.3.1/shared_files/symping.html).
