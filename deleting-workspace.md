...
2. Copy and paste the [Delete a workspace using Schematics Python API](/docs/hpc-slurm?topic=hpc-slurm-deleting-workspace&interface=api#example-request-delete-workspace) example request to your Python file.
...
DEBUG:urllib3.connectionpool:https://us.schematics.cloud.ibm.com:443 "DELETE /v1/workspaces/us-south.workspace.Sample-Schematics-Api-workspace.0f4b9089?destroy_resources=false HTTP/1.1" 200 2
""
