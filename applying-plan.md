...
2. Copy and paste the [Apply a plan using {{site.data.keyword.bpshort}} Python API](/docs/hpc-slurm?topic=hpc-slurm-applying-plan&interface=api#example-request-apply) example request to your Python file.
...
DEBUG:urllib3.connectionpool:https://us.schematics.cloud.ibm.com:443 "PUT /v1/workspaces/us-south.workspace.Sample-Schematics-Api-workspace.0f4b9089/apply HTTP/1.1" 202 49
{
  "activityid": "341a4dc02beb912e4aa8732ffd28bf11"
}
